...
//        )
        ...
        articaltext.text = " NutriNova: Elevating Your Nutrition with Nutrient-Dense Foods\n"
         ...
         subtext.text=  "NutriNova is all about taking your nutrition to the next level by incorporating nutrient-dense foods into your diet. These foods are packed with essential vitamins, minerals, antioxidants, and other nutrients that support optimal health and well-being.\n" +
                "\n" +
          ...
          subtext2.text= ". NutriNova:TIPS\n" +
               ...
               subtext3.text= " 1. Eat a variety of protein sources to ensure you're getting all essential amino acids. Incorporate lean proteins such as poultry, fish, tofu, tempeh, legumes, nuts, and seeds into your meals.\n" +
                "\n" +
                " 2. Consume foods rich in calcium to support bone health and muscle function. Include dairy products, fortified plant-based milks, leafy greens, tofu, almonds, and sesame seeds in your diet to meet your calcium needs.\n" +
                "\n" +
                " 3. Don't forget about fiber, which is essential for digestive health and can help lower cholesterol levels and regulate blood sugar. Aim to include plenty of fiber-rich foods like fruits, vegetables, whole grains, legumes, nuts, and seeds in your diet.\n" +
                "\n" +
                " 4. Be mindful of your vitamin D intake, especially if you have limited sun exposure. Consider incorporating vitamin D-rich foods such as fatty fish, fortified dairy products, fortified plant-based milks, egg yolks, and mushrooms into your diet.\n" +
                "\n" +
                ...
                "\n" +
                " 6. Seek out whole, minimally processed foods that are rich in vitamins, minerals, and other essential nutrients to support your overall health and well-being. Focus on nourishing your body with nutrient-dense foods that provide lasting energy and promote optimal health.\n" +
                "\n" +
                "7. Opt for whole foods over processed foods to maximize your nutrient intake and promote optimal nutrition."+
        "\n" +
                " 8. Another key aspect of NutriNova eating is to pay attention to the quality of your food choices. This means opting for whole, minimally processed foods whenever possible and avoiding foods that are high in added sugars, unhealthy fats, and artificial additives.\n" +
                "\n" +
                " 9. Incorporating nutrient-dense foods into your diet can have numerous health benefits, including improved energy levels, enhanced immune function, better digestion, and reduced risk of chronic disease. By prioritizing foods that nourish your body from the inside out, you can support your overall health and well-being and feel your best every day.\n" +
                "\n" +
