...
//        )
        ...
        articaltext.text = "  HealthfulHaven: Creating a Nurturing Environment for Healthy Eating\n"
           ...
           subtext.text= "HealthfulHaven is more than just a way of eating—it's a lifestyle that encompasses creating a supportive environment for healthy eating habits to thrive. From stocking your kitchen with nutritious foods to planning and preparing meals ahead of time, HealthfulHaven is all about setting yourself up for success on your health journey.\n" +
            ...
            subtext2.text=    " HealthfulHaven: Tips\n" +
                "\n" +
           ...
           subtext3.text=  " 1. Prepare meals in batches and portion them out for convenient grab-and-go options during busy days. Investing in reusable containers and meal prep tools can help streamline the process and make meal prep more enjoyable.\n" +
                "\n" +
                " 2. Get creative with meal ideas by incorporating a variety of flavors, textures, and cuisines into your cooking. Don't be afraid to experiment with different ingredients and cooking methods to keep meals exciting and satisfying.\n" +
                "\n" +
                " 3. Embrace the concept of \"eating the rainbow\" by including a colorful variety of fruits and vegetables in your meals. Different colors often indicate different nutrients, so aim for a diverse selection to maximize your nutrient intake.\n" +
                "\n" +
                " 4. Focus on whole, minimally processed foods that are rich in nutrients and free from artificial additives and preservatives. Read food labels carefully and choose products with simple, recognizable ingredients.\n" +
                "\n" +
                " 5. Practice mindful eating by paying attention to your body's hunger and fullness cues, as well as the taste, texture, and enjoyment of your food. Avoid distractions while eating and savor each bite to enhance the eating experience.\n" +
                "\n" +
                " 6. Stay hydrated by drinking plenty of water throughout the day. Carry a reusable water bottle with you and sip water regularly, especially during and after exercise or when you're feeling thirsty.\n" +
                "\n" +
                " 7. Be kind to yourself and allow for flexibility in your eating habits. Focus on progress over perfection and celebrate your successes, no matter how small. Remember that healthy eating is about nourishing your body and soul with nutritious foods that make you feel your best."+
        "\n" +
                " 8. HealthfulHaven: TIPS\n" +

                "\n" +
                " 8. In addition to meal planning, HealthfulHaven also emphasizes the importance of meal preparation. Taking the time to prepare meals ahead of time can save you time and energy during the week and make it easier to stick to your health goals. Consider batch cooking on the weekends and portioning out meals for easy grab-and-go options throughout the week.\n" +
                "\n" +
                " 9. Creating a supportive environment for healthy eating also means surrounding yourself with positive influences and support systems. Whether it's joining a cooking class, finding a workout buddy, or seeking out online communities that share your health goals, surrounding yourself with like-minded individuals can help keep you motivated and accountable on your health journey.\n" +
                "\n" +
