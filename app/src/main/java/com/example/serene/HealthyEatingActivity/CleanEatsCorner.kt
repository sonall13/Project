...
//        )
       ...
       subtext.text= "In a world filled with processed foods and artificial additives, many people are turning to clean eating as a way to prioritize their health and well-being. CleanEats Corner is all about embracing a clean eating lifestyle that focuses on consuming whole, minimally processed foods that are as close to their natural state as possible.\n" +
          "\n" +
       ...
       subtext2.text=   "CleanEats Corner: tips\n" +
          "\n" +
         ...
         subtext3.text= " 1. One of the key principles of clean eating is to focus on whole foods that are rich in nutrients and free from added sugars, unhealthy fats, and excessive salt. This means filling our plates with plenty of fruits and vegetables, whole grains, lean proteins, and healthy fats, while avoiding highly processed foods and sugary snacks.\n" +
          "\n" +
          " 2. In addition to prioritizing whole, nutrient-rich foods, CleanEats Corner also emphasizes the importance of mindful eating. This means paying attention to our hunger and fullness cues, as well as the taste, texture, and enjoyment of our food. By slowing down and savoring each bite, we can better appreciate the flavors and nourishment that whole foods provide.\n" +
          "\n" +
          " 3. Another key aspect of clean eating is cooking meals at home using fresh, whole ingredients. By preparing our own meals, we can have more control over the ingredients and cooking methods used, allowing us to make healthier choices and avoid hidden sources of unhealthy additives.\n" +
          "\n" +
          " 4. Prioritize clean, whole foods that are minimally processed and free from artificial additives, preservatives, and chemicals. Choose foods with simple, recognizable ingredients to support optimal health.\n" +
          "\n" +
          " 5. Read food labels carefully and avoid products with long lists of artificial ingredients, added sugars, and unhealthy fats. Opt for products with minimal ingredients and no artificial additives whenever possible.\n" +
          "\n" +
          " 6. Cook meals from scratch using fresh, whole ingredients. Homemade meals allow you to control the quality of the ingredients and avoid hidden sources of unhealthy additives.\n" +
          "\n" +
          " 7. Choose organic produce when feasible to minimize exposure to pesticides and other chemicals. Prioritize organic options for fruits and vegetables that are known to have higher pesticide residues.\n" +
          "\n" +
          " 8. Limit your intake of processed foods such as sugary snacks, fast food, and packaged convenience foods. These foods are often high in unhealthy fats, added sugars, and sodium, which can contribute to poor health.\n" +
          "\n" +
          " 9. Stock your pantry with clean eating essentials such as whole grains, legumes, nuts, seeds, herbs, and spices. Having a well-stocked pantry makes it easier to prepare nutritious meals at home.\n" +
          "\n" +
